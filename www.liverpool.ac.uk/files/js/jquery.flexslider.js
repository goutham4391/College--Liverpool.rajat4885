  ...
  $.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      if (slider.vars.directionNav) {
        var directionNavScaffold = $('<ul class="flex-direction-nav"><li><a class="next" href="#"><span>' + slider.vars.nextText + '</span></a></li><li><a class="prev" href="#"><span>' + slider.vars.prevText + '</span></a></li></ul>');
      ...
      if (slider.vars.controlNav) {
        if (slider.manualExists) {
          ...
          var controlNavScaffold = $('<ul class="flex-control-nav"></ol>');
          var j = 1;
